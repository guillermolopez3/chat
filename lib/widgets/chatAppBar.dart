import 'package:chat/config/assets.dart';
import 'package:chat/config/palette.dart';
import 'package:flutter/material.dart';

/*
* PreferredSize... se usa para que este widget se use como appbar
 */
class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    var textHeading = TextStyle(
        ...
        fontSize: 20); //Estilo para el Nombre de usuario
    var textStyle =
        TextStyle(color: Palette.secondaryColor); //estilo para el resto
